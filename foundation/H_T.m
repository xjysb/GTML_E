...
if strcmp(flag, 'Gas')
    ...
    tz = T / 1000;
    Xm = [ 1/(1 + FAR) FAR/(1 + FAR) ]; 
    H = Xm(1)*(0.992313*tz+0.236688*tz^2/2-1.852148*tz^3/3+6.083152*tz^4/4-8.893933*tz^5/5+7.097112*tz^6/6-3.234725*tz^7/7+0.794571*tz^8/8-0.081873*tz^9/9+0.422178);
 
    if FAR > 1e-5
        H = H+Xm(2)*(-0.718874*tz+8.747481*tz^2/2-15.863157*tz^3/3+17.254096*tz^4/4-10.233795*tz^5/5+3.081778*tz^6/6-0.361112*tz^7/7+0.0555930);
    end
