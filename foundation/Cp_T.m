...
if strcmp(flag, 'Gas')
    ...
    Cp = Xm(1)*(0.992313+0.236688*tz-1.852148*tz^2+6.083152*tz^3-8.893933*tz^4+7.097112*tz^5-3.234725*tz^6+0.794571*tz^7-0.081873*tz^8);

    if FAR > 1e-5
        Cp = Cp+Xm(2)*(-0.718874+8.747481*tz-15.863157*tz^2+17.254096*tz^3-10.233795*tz^4+3.081778*tz^5-0.361112*tz^6-0.003919*tz^7);
    end
end
